...
namespace Store.Domain.Concrete
{
    ...
    {
        public string MailToAddress = "ArtsiomBelikov@gmail.com";
        public string MailFromAddress = "ArtsiomBelikov@gmail.com";
    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                body.AppendFormat("Общая pстоимость: {0:c}", cart.ComputeTotalValue())
                    .AppendLine("---")
                    .AppendLine("Доставка:")
